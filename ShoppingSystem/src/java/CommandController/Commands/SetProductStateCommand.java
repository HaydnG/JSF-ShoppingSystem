 ...
 * @author haydn
 */
public class SetProductStateCommand implements Command {
    
    private ProductDTO Product;
    private ProductRowGateway ProductRG;

    public SetProductStateCommand(ProductDTO productDTO) {
    ...
    public Object execute() {
        return this.ProductRG.SetProductState(this.Product);
    }
